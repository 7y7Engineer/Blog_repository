					...
					<div class="text">
                    	...
                    	<?php 
						   if(isset($title)
							  ...
							  {
								$result=mysql_query("UPDATE `articles-computing` SET title='$title',meta_description='$meta_description',meta_keywords='$meta_keywords',date='$date',description='$description',text='$text',author='$author' WHERE id='$id'");
