...
<html>
	<head>
		<title>Удаление статьи по физике</title>
		...
		<div class="karkas">
			...
			<div class="content-main">
				...
				<div class="content">
					<div class="text">
                    	<h1>удаление</h1>
                        <form action="drop-article-physics.php" method="post">
            			<?php
		  						...
		  						printf('<table align="center" class="articles">
										<tr>
	   					    				<td class="articles-title">
												<h2><input name="id" type="radio" value="%s"><a href="edit-article-physics.php?id=%s" class="articles-name">%s</a></h2>
