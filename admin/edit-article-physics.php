...
<html>
	<head>
		<title>Редактирование статьи по физике</title>
			...
			<div class="content-main">
				...
				<div class="content">
					<div class="text">
						...
						if(!isset($id))
						{
							$result=mysql_query("SELECT id,title,description,date,author FROM `articles-physics`",$db);
		  						...
		  						printf('<table align="center" class="articles">
										<tr>
	   					    				<td class="articles-title">
												<h2><a href="edit-article-physics.php?id=%s" class="articles-name">%s</a></h2>
						...
						{
							$result=mysql_query("SELECT * FROM `articles-physics` WHERE id=$id",$db);
							$myrow=mysql_fetch_array($result);
print <<<HERE
					   	<form action="update-article-physics.php" method="post" name="form1">
					   		<p>
