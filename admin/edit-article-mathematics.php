...
<html>
	<head>
		<title>Редактирование статьи по математике</title>
			...
			<div class="content-main">
				...
				<div class="content">
					<div class="text">
		  						...
		  						printf('<table align="center" class="articles">
										<tr>
	   					    				<td class="articles-title">
												<h2><a href="edit-article-mathematics.php?id=%s" class="articles-name">%s</a></h2>
						...
						{
							$result=mysql_query("SELECT * FROM `articles-mathematics` WHERE id=$id",$db);
							$myrow=mysql_fetch_array($result);
print <<<HERE
					   	<form action="update-article-mathematics.php" method="post" name="form1">
					   		<p>
