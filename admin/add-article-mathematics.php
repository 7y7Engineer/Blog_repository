					...
					<div class="text">
                    	...
                    	<?php 
						   if(isset($title)
							  ...
							  {
								$result=mysql_query("INSERT INTO `articles-mathematics` (title,meta_description,meta_keywords,date,description,text,author) VALUES ('$title','$meta_description','$meta_keywords','$date','$description','$text','$author')");
								if($result=='true') {echo "<h1>Данные успешно занесены в БД !</h1>";}
								else {echo "<h1>Данные не занесены в БД !</h1>";}
							  }
						  else{
