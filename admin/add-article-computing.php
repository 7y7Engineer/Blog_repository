					...
					<div class="text">
                    	...
                    	<?php 
						   if(isset($title)
							  ...
							  {
								$result=mysql_query("INSERT INTO `articles-computing` (title,meta_description,meta_keywords,date,description,text,author) VALUES ('$title','$meta_description','$meta_keywords','$date','$description','$text','$author')");
